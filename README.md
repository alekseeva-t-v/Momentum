...
Разработана декстопная версия приложения, которая включает следующие блоки:
...
Присутствует также мобильная версия с ограниченным функционалом.

Версия для планшета включает следующие блоки:
- Время
- Дата
- Приветствие
- Аудиоплеер
...
Также для всех версий предусмотрен слайдер фоновых изображений.

![mobile-version](./public/images/mobile-2.jpg)
...
Данные о погоде предоставляют API погоды: **_OpenWeatherMap API_**.
...
### **_Получение фонового изображения от API_**
